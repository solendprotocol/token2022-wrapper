...
export const PROGRAM_ID = new web3.PublicKey("6E9iP7p4Gx2e6c2Yt4MHY5T1aZ8RWhrmF9p6bXkGWiza");
...
export const RENT_SYSVAR = new web3.PublicKey("SysvarRent111111111111111111111111111111111");